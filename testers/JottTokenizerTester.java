...
public class JottTokenizerTester {
    ...
    private void createTestCases(){
        ...
        /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
        /* Start of our custom test cases: */

        // Empty file
        ArrayList<Token> emptyFile = new ArrayList<>();
        filename = "tokenizerTestCases/emptyFile.jott";
        testCases.add(new TestCase("Empty File", filename, emptyFile, false));


        // File with comment at end
        ArrayList<Token> endsWithComment = new ArrayList<>();
        filename = "tokenizerTestCases/endsWithComment.jott";
        for(char c: mathOps.toCharArray()){
            endsWithComment.add(new Token("" + c, filename, 1, TokenType.MATH_OP));
        }
        testCases.add(new TestCase("File ends with a comment", filename, endsWithComment, false));


        // Longer example
        ArrayList<Token> phase1CustomExample1 = new ArrayList<>();
        filename = "tokenizerTestCases/phase1CustomExample1.jott";
        phase1CustomExample1.add(new Token("Integer", filename, 1, TokenType.ID_KEYWORD));
        phase1CustomExample1.add(new Token("x", filename, 1, TokenType.ID_KEYWORD));
        phase1CustomExample1.add(new Token(";", filename, 1, TokenType.SEMICOLON));
        phase1CustomExample1.add(new Token("x", filename, 2, TokenType.ID_KEYWORD));
        phase1CustomExample1.add(new Token("=", filename, 2, TokenType.ASSIGN));
        phase1CustomExample1.add(new Token("5", filename, 2, TokenType.NUMBER));
        phase1CustomExample1.add(new Token(";", filename, 2, TokenType.SEMICOLON));
        phase1CustomExample1.add(new Token("::", filename, 3, TokenType.FC_HEADER));
        phase1CustomExample1.add(new Token("print", filename, 3, TokenType.ID_KEYWORD));
        phase1CustomExample1.add(new Token("[", filename, 3, TokenType.L_BRACKET));
        phase1CustomExample1.add(new Token("x", filename, 3, TokenType.ID_KEYWORD));
        phase1CustomExample1.add(new Token("+", filename, 3, TokenType.MATH_OP));
        phase1CustomExample1.add(new Token("3.2", filename, 3, TokenType.NUMBER));
        phase1CustomExample1.add(new Token("]", filename, 3, TokenType.R_BRACKET));
        testCases.add(new TestCase("phase1CustomExample1", filename, phase1CustomExample1, false));
        /* End of our custom test cases. */
        /*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
    }
